...
demoModule.service('langServiceRx', LangService);
demoModule.component('lang', LangComponent);
demoModule.component('home', HomeComponent);
demoModule.component('page1', P1Component);
demoModule.component('page2', P2Component);
demoModule.component('rightMenu', RightMenuComponent);
demoModule.component('completeBlock', CompleteBlock);
